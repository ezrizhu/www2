                    ...
                    div class="main" {
                        ...
                        div class="footer" {
                            ...
                            div class="badges" {
                                ...
                                a target="_blank" href="https://hayl.in" {
                                ...
                                a target="_blank" href="https://umbresp.cat/" {
                                    img src="/assets/img/badges/umbresp.gif" alt="umbresp";
                                }
                                a target="_blank" href="https://kria.tel/" {
                                    img src="/assets/img/badges/kria.tel.png" alt="kria";
                                }
                                ...
                                a target="_blank" href="https://isabelroses.com/" {
                                    img src="/assets/img/badges/isabelroses.gif" alt="isabelroses";
                                }
                                a target="_blank" href="https://joe.lothan.net/" {
                                    img src="/assets/img/badges/ert.png" alt="joelothan";
                                }
                                a target="_blank" href="https://cpli.dev/" {
                                    img src="/assets/img/badges/cpli.gif" alt="cpli";
                                }
